...
| 2     | Pending     | Test infra cleanup                                        | Keep memfs.ts, extract runCommand, expectLogEntry, shared fixtures |
| 3     | Pending     | FsErrorMapper + Display dedup                             | fs error mapping in lib/, shared json handler                      |
