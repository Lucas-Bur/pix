...
random-scout baseline still runs alongside every structured search. The Halton-vs-Sobol-vs-random
comparison landed in the Schema 29 section below: all differences fall inside measurement noise.
